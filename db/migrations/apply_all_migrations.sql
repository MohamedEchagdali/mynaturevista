-- ============================================================================
-- SCRIPT DE MIGRACIÓN COMPLETA - MEJORAS SEGURIDAD B2B
-- ============================================================================
-- Aplica todos los cambios necesarios en orden correcto
-- Fecha: 2026-01-07
-- Versión: 1.0.0
-- ============================================================================

-- Configuración para prevenir errores parciales
BEGIN;

-- ============================================================================
-- PASO 3: Añadir token_version a clients
-- ============================================================================
DO $$
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE clients ADD COLUMN token_version INTEGER DEFAULT 0 NOT NULL;
        RAISE NOTICE 'Columna token_version añadida a tabla clients';
    ELSE
        RAISE NOTICE 'Columna token_version ya existe en tabla clients';
    END IF;
END $$;

-- Índice para performance en autenticación
...
RAISE NOTICE 'PASO 3 completado: token_version implementado';

-- ============================================================================
-- PASO 4: Crear tablas account/user para futuro multi-usuario B2B
-- ============================================================================
